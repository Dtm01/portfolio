...
<h2>Rules</h2>
The 2024-2025 competition had a theme of X-1 Supersonic flight where the main aircraft had the task of dropped a smaller, lighter aircraft (glider). The main aircraft constraints were:

~ Maximum of 6 ft wingspan

~ Pylons must be removable (related to Mission 2)
...
~ Have flashing lights after deployment

~ Land in a specific region specified in the rules
...
Ground Mission: Time for to put plane in flight ready configuration, load fuel tanks, unload fuel tanks, load glider, and unload glider

Mission 1: 3 laps

Mission 2: External fuel tank payload in 16 oz bottles attached by pylons, 3 laps

Mission 3: External fuel tanks (do not need to have weight), Maximum laps in 5 minute window, X-1 vehicle must be deployed and on the ground before the end of this window


Goals:

~ Maximize external payload weight

~ Minimize lap times

~ Minimize ground mission time by making efficient loading and parking systems

~ Create an autonomous glider
